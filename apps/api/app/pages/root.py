"""Root landing page for Evexía EAP with API links."""
...
<body>
    <div class="wrap">
        <header class="hero">
            ...
            <p class="tagline">Employee Assistance Program Management API</p>
        </header>
        ...
        <section class="card" aria-labelledby="new-here-heading">
            ...
            <code>DATABASE_URL</code> and secrets before starting.</p>
            <div class="links">
        ...
        <footer class="foot">
            {app_name} · API docs at <code>/docs</code>
        </footer>
    </div>
    <script>
        (function () {{
