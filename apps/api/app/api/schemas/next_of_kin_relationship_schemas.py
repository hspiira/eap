"""Next-of-kin relationship taxonomy API schemas."""

from pydantic import BaseModel, ConfigDict, Field


class NextOfKinRelationshipResponse(BaseModel):
...
class NextOfKinRelationshipCreate(BaseModel):
...
class NextOfKinRelationshipUpdate(BaseModel):
