...
class ContractMapper:
    ...
    def to_entity(model: ContractModel) -> ContractEntity:
        ...
        return ContractEntity(
            ...
            renewed_from_id=(ContractId(model.renewed_from_id) if model.renewed_from_id else None),
    ...
    def to_model(entity: ContractEntity) -> ContractModel:
        ...
        return ContractModel(
            ...
            renewed_from_id=entity.renewed_from_id.value if entity.renewed_from_id else None,
