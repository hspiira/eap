 ...
 */
export function RequireClinicalScope({ redirectAfterLogin, children }: RequireClinicalScopeProps) {
  return (
    ...
    <div className="grid min-h-svh w-full place-items-center bg-bg p-6 text-fg">
      <div className="max-w-md space-y-3 text-center">
        ...
        <p className="text-sm text-fg-muted">
          This area holds clinical records and is restricted to counsellors granted clinical access.
          Contact a platform admin if you believe you should have access.
        </p>
      </div>
    </div>
  )
