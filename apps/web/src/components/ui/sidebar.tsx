...
const SidebarMenu = React.forwardRef<HTMLUListElement, React.HTMLAttributes<HTMLUListElement>>(
  ({ className, ...props }, ref) => (
    <ul ref={ref} data-sidebar="menu" className={cn("flex flex-col", className)} {...props} />
  ),
)
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.HTMLAttributes<HTMLUListElement>>(
  ({ className, ...props }, ref) => (
    <ul
      ...
      className={cn("ml-3 flex flex-col gap-0.5 border-l border-sidebar-border pl-2", className)}
      {...props}
    />
  ),
)
...
const SidebarInset = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ className, ...props }, ref) => (
    <main
      ref={ref}
      data-sidebar="inset"
      className={cn("flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden bg-bg", className)}
      {...props}
    />
  ),
)
