...
class CareCallbackCampaignModel(CuidMixin, TenantMixin, Base, TimestampMixin):
    ...
    counsellor_pool: Mapped[list[str]] = mapped_column(
...
class OutreachRecordModel(CuidMixin, TenantMixin, Base, TimestampMixin):
    ...
    triage_instrument_code: Mapped[str | None] = mapped_column(
        String(100), nullable=True
    )
    triage_responses: Mapped[dict[str, Any] | None] = mapped_column(
        JSONB, nullable=True
    )
