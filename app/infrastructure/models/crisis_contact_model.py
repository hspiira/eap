...
class CrisisContactModel(CuidMixin, TenantMixin, Base, TimestampMixin):
    ...
    clinical_subject_id: Mapped[str | None] = mapped_column(String(25), nullable=True, index=True)
    ...
    cssrs_administered: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    risk_assessment_id: Mapped[str | None] = mapped_column(String(25), nullable=True)
    safety_plan_id: Mapped[str | None] = mapped_column(String(25), nullable=True)
