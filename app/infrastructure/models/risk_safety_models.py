...
class RiskAssessmentModel(CuidMixin, TenantMixin, Base, TimestampMixin):
    ...
    imminent_harm_to_self: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    imminent_harm_to_others: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    child_safety_concern: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    vulnerable_adult_concern: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
    requires_safety_plan: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=False
    )
...
class SafetyPlanModel(CuidMixin, TenantMixin, Base, TimestampMixin):
    ...
    warning_signs: Mapped[list[str]] = mapped_column(
        JSONB, nullable=False, server_default="[]"
    )
    ...
    supersedes_safety_plan_id: Mapped[str | None] = mapped_column(
